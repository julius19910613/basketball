...
业余篮球球队的微信小程序，覆盖 **球员管理**、**篮球活动**、**比赛记录**、**智能分组** 与 **个人中心** 五条核心链路。
...
- `registration_closed`：报名截止，等待分组
- `grouped`：三队分组完成，待生成赛程
- `in_progress`：6 场双循环赛程已生成
- `finished`：活动全部完成
